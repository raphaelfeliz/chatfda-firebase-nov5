...
export class TriageMachine {
    ...
    private askJanelaMaximarFolhas(): QuestionState {
        return {
            ...
            options: [
                { label: "1 Módulo", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_maximar_1modulo.webp", sku: "J-MAX-VIDRO-008" },
                { label: "2 Módulos", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_maximar_2modulos.webp", sku: "J-MAX-VIDRO-009" },
                { label: "3 Módulos", value: "3", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_maximar_3modulos.webp", sku: "J-MAX-VIDRO-010" }
            ]
        };
    }
    ...
    private askJanelaCorrerPersianaTipo(): QuestionState {
        return {
            ...
            options: [
                { label: "Motorizada", value: "motorizada", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_2folhas_persiana-integrada_motorizada.webp", sku: "J-COR-VIDRO-PERS-MOT-001" },
                { label: "Manual", value: "manual", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_2folhas_persiana_manual.webp", sku: "J-COR-VIDRO-PERS-MAN-002" }
            ]
        };
    }
    ...
    private askPortaCorrerPersianaTipo(): QuestionState {
        return {
            ...
            question: "A persiana deve ser motorizada ou manual?",
            options: [
                { label: "Motorizada", value: "motorizada", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_2folhas_persiana_integrada_motorizada.webp", sku: "P-COR-VIDRO-PERS-MOT-011" },
                { label: "Manual", value: "manual", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_2folhas_persiana_integrada_manual.webp", sku: "P-COR-VIDRO-PERS-MAN-012" }
            ]
        };
    }
    ...
    private askPortaGiroFolhas(materialValue: string, stateID: string): QuestionState {
        const optionsMap: { [key: string]: Option[] } = {
            "lambri": [
                { label: "1 Folha", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_1folha_lambris.webp", sku: "P-GIR-LAM-018" },
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_2folhas_lambris.webp", sku: "P-GIR-LAM-019" }
            ],
            "veneziana": [
                { label: "1 Folha", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_1folha_veneziana.webp", sku: "P-GIR-VEN-020" },
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_2folhas_veneziana.webp", sku: "P-GIR-VEN-021" }
            ],
            "vidro": [
                { label: "1 Folha", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_1folha_vidro.webp", sku: "P-GIR-VIDRO-022" },
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_2folhas_vidro.webp", sku: "P-GIR-VIDRO-023" }
            ],
            "vidro + lambri": [
                { label: "1 Folha", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_1folha_metade_lambris.webp", sku: "P-GIR-MVL-024" },
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_2folhas_metade_lambris.webp", sku: "P-GIR-MVL-025" }
            ],
            "vidro + veneziana": [
                { label: "1 Folha", value: "1", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_1folha_metade_veneziana.webp", sku: "P-GIR-MVV-026" },
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_giro_2folhas_metade_veneziana.webp", sku: "P-GIR-MVV-027" }
            ]
        };
        return {
            stateID: stateID,
    ...
    private askJanelaCorrerVidroFolhas(): QuestionState {
        return {
            ...
            options: [
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_2folhas_manual.webp", sku: "J-COR-VIDRO-003" },
                { label: "3 Folhas", value: "3", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_3folhas_manual.webp", sku: "J-COR-VIDRO-004" },
                { label: "4 Folhas", value: "4", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_4folhas_manual.webp", sku: "J-COR-VIDRO-005" }
            ]
        };
    }
    ...
    private askJanelaCorrerVeneFolhas(): QuestionState {
        return {
            ...
            question: "Com quantas folhas (partes)?",
            options: [
                { label: "3 Folhas", value: "3", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_2folhas_veneziana.webp", sku: "J-COR-VIDRO-VEN-006" },
                { label: "6 Folhas", value: "6", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/janela_de_correr_6folhas_veneziana.webp", sku: "J-COR-VIDRO-VEN-007" }
            ]
        };
    }
    ...
    private askPortaCorrerVidroFolhas(): QuestionState {
        return {
            ...
            question: "Com quantas folhas (partes)?",
            options: [
                { label: "2 Folhas", value: "2", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_2folhas_manual.webp", sku: "P-COR-VIDRO-013" },
                { label: "3 Folhas", value: "3", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_3folhas_manual.webp", sku: "P-COR-VIDRO-014" },
                { label: "4 Folhas", value: "4", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_4folhas_manual.webp", sku: "P-COR-VIDRO-015" }
            ]
        };
    }
    ...
    private askPortaCorrerVeneFolhas(): QuestionState {
        return {
            ...
            question: "Com quantas folhas (partes)?",
            options: [
                { label: "3 Folhas", value: "3", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_2folhas_veneziana.webp", sku: "P-COR-VIDRO-VEN-016" },
                { label: "6 Folhas", value: "6", picture: "https://storage.googleapis.com/ai-studio-bucket-632357271427-us-west1/assets/images/porta_de_correr_6folhas_veneziana.webp", sku: "P-COR-VIDRO-VEN-017" }
            ]
        };
    }
